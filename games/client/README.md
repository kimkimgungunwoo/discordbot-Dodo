...
First to seven wins in volleyball. The host can request a rematch from the results screen. Touch controls appear on coarse-pointer devices. Sound is synthesized locally after a user gesture and can be muted.
