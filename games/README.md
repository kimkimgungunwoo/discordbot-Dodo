...
- 15×15 자유룰: 흑 선공, 5개 이상 연결하면 승리, 금수 없음, 만석이면 무승부.
...
- `shared/omok.ts`: 연습 및 서버 공통 규칙/AI. 중간은 공격·방어 위협 평가, 쉬움은 후보 선택에 오차, 어려움·극한·초월은 시간 예산 안에서 반복 심화 탐색하며 초월이 가장 오래(최대 2초)·넓게 읽는다. 사람 상대 체감 난이도는 추가 조정할 수 있다.
