...
import type { Input, Definition, Frame, Result, Peer } from "./protocol.js";
import { validInput } from "./protocol.js";

// 클라이언트 volleyball/constants.ts의 WIN_SCORE와 반드시 같은 값이어야 한다.
const WIN_SCORE = 7;
